...
// Fetch forms data validations for response 
export const fetchFormsDataValidations = createAction('[Data] Fetch Forms Data Validations');
export const fetchFormsDataValidationsSuccess = createAction('[Data] Fetch Forms Data Validations Success', props<{ validations: any }>());
export const fetchFormsDataValidationsFailure = createAction('[Data] Fetch Forms Data Validations Failure', props<{ error: string }>());
